...
irm https://raw.githubusercontent.com/TravisPasta/Automated_Home_Theater_Setup/home_pc/bootstrap_phase1.ps1 | iex
````
...
```powershell
irm https://raw.githubusercontent.com/TravisPasta/Automated_Home_Theater_Setup/home_pc/bootstrap.ps1 | iex
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/TravisPasta/Automated_Home_Theater_Setup/home_pc/bootstrap.sh | bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/TravisPasta/Automated_Home_Theater_Setup/home_pc/benchmark.sh | bash
```
...
```powershell
irm https://raw.githubusercontent.com/TravisPasta/Automated_Home_Theater_Setup/home_pc/benchmark.ps1 | iex
```
...
### Linux Setup
```bash
curl -fsSL https://raw.githubusercontent.com/TravisPasta/Automated_Home_Theater_Setup/home_pc/shutdown_server/setup_shutdown_linux.sh | bash
```
...
```powershell
irm https://raw.githubusercontent.com/TravisPasta/Automated_Home_Theater_Setup/home_pc/shutdown_server/setup_shutdown_windows.ps1 | iex
```
